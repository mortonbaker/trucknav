...
import com.morton.trucknav.ui.theme.FerrostarTheme
...
class MainActivity : ComponentActivity(), AndroidTtsStatusListener {
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    setContent {
      FerrostarTheme {
        ...
        Surface { CockpitScreen() }
      }
    }
  }

  // Head unit: no Android status bar, no navigation buttons. A swipe from an
  // edge shows them transiently and the system hides them again by itself.
  ...
  override fun onBackPressed() { /* home app: nowhere to go */ }
}
