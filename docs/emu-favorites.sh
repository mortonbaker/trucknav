...
# tapping it starts a route within 3 s; recent appears after a route; files exist. usage: [E=emulator-5556] emu-favorites.sh <tag>
export PATH=$PATH:$HOME/Android/Sdk/platform-tools
E=${E:-emulator-5554}; P=com.morton.trucknav; T=${1:-run}; F=/sdcard/Android/data/$P/files
...
~/bin/ui.sh $E tapx "Home" >/dev/null; sleep 1; echo "sheet after save: $(~/bin/ui.sh $E dump | grep -oE 'text="Saved"' | head -1)"
