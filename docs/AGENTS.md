...
| 2026-09-23 09:30 | claude-nav | MERGED controls-s23 → main as 0.38.0 / 143. astra-3: S23 a–d corner controls (Layers/Add-stop top-right under overview/mute, recenter + zoom bottom-right, 56 dp / 12 dp / 16 dp). Gate on emulator-5558: cockpit 13/13, s23-fullmap 7/7, s23-controls 34/34 (S2 camera incl.), s19-stops 8/8, 0 crashes; harnesses made host/SERIAL-portable. Release installed on the tablet (LAN adb), apk-drop/trucknav-0.38.0.apk. S22 live-key work parked (no TomTom key). Next: S18 voice commands. |
