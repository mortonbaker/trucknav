...
atlas01 stopped answering at ~19:10 with two emulators, three agents' Gradle/Kotlin daemons and a release build on it. Until the operator power-cycles it, **build01 (tailnet `build01`, 8 cores, 32 GB) is the merge target, build host and tablet installer.**
